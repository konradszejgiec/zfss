...
exports.displayMainPage = async (req, res) => {
  res.render("main", { route: "background-image: url('../../assets/img/home-bg.jpg')", sectionMsg: "Zakładowy Fundusz Świadczeń Socjalnych" });
};
...
exports.displayFaq = async (req, res) => {
  try {
    ...
    if (personData) {
      res.render("faq", { route: "background-image: url('../../assets/img/faq-bg.jpg')", sectionMsg: "Odpowiedzi na najczęściej zadawane pytania" });
    } else
      res.render("access-message", {
...
exports.displayAccessPage = async (req, res) => {
  ...
  res.render("access", { route: `background-image: url('../../assets/img/${image}-bg.jpg')`, sectionMsg: message, link: req.path });
};

exports.displayAddApplication = async (req, res) => {
  res.render("application", { route: "background-image: url('../../assets/img/application-bg.jpg')", sectionMsg: "Wniosek o dofinansowanie" });
};

exports.displayRodo = async (req, res) => {
  res.render("rodo", { route: "background-image: url('../../assets/img/privacy-policy-bg.jpg')", sectionMsg: "Klauzula RODO" });
};

exports.displayContact = async (req, res) => {
  res.render("contact", { route: "background-image: url('../../assets/img/contact-bg.jpg')", sectionMsg: "Kontakt" });
};
...
exports.displayPostPage = async (req, res) => {
  try {
    if (req.query.password == process.env.FORM_PASSWORD) {
      res.render("post-data", { route: "background-image: url('../../assets/img/password-success-bg.jpg')", sectionMsg: "Panel administratora" });
    } else
      res.render("access-message", {
        route: "background-image: url('../../assets/img/password-bg.jpg')",
        sectionMsg: "Panel administratora",
